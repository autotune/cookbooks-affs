      ...
      def set_selinux_label
        ...
        unless compare_selinux_label
          ...
          if @new_resource.selinux_label != nil 
            puts "SEANDEBUG: setting #{@new_resource.path} to specified context #{@new_resource.selinux_label}"
            selinux_set_context(@new_resource.path,@new_resource.selinux_label)
          else
            # otherwise, use default context
            puts "SEANDEBUG: setting #{@new_resource.path} to default context #{selinux_get_default_context(@new_resource.path)}"
