...
For RHEL5, Centos5, and Scientific Linux 5, you need to have a package repository that includes Nagios3.
RHEL family distributions will install an .htaccess file with the password "nagiosadmin" (you should change that.)
...
mitedefault_host.max_check_attempts
